...
export default function AgentNetworkPage() {
  ...
  const [selectedAgent, setSelectedAgent] = useState<AgentSystemInfo | null>(null)
  ...
  return (
      <div className="p-6 space-y-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tr className="border-b border-neutral-700">
                  ...
                  <th className="text-left py-3 px-4 text-xs font-medium text-neutral-400 tracking-wider">OS</th>
                  <th className="text-left py-3 px-4 text-xs font-medium text-neutral-400 tracking-wider">VCPU</th>
                  <th className="text-left py-3 px-4 text-xs font-medium text-neutral-400 tracking-wider">RAM</th>
                  <th className="text-left py-3 px-4 text-xs font-medium text-neutral-400 tracking-wider">DETAIL</th>
                </tr>
                </thead>
                <tbody>
                {filteredAgents.map((agent, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <button onClick={() => showDetail()} className="text-neutral-400 hover:text-orange-500">
                            Detail
                        </button>
                      </td>
                    </tr>
        ...
        {/*  Modal */}
        {selectedAgent && <AgentMigrationCostModal selectedAgentSystem={selectedAgent} setSelectedAgentSystem={setSelectedAgent} />}
      </div>
  )
}
